...
You will create a Spring Boot REST application using JDBC Template to access the database.
...
You must use unit tests to thoroughly test all of the public DAO interface methods and the game rules in the service layer.